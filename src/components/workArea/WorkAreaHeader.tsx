...
const WorkAreaHeader: React.FC<WorkAreaHeaderProps> = ({
  totalDesk,
  occupied,
  vacant,
}) => {
  ...
  return (
    <div className="w-full h-fit bg-[#1D1D41] flex flex-col gap-4 p-4">
      ...
      <div className="p-8">
        <h1 className="text-lg font-bold mb-4">Employee Working Status</h1>
        <StatusTimeline  />
      </div>
    </div>
  );
